...
# Call background setup (make sure image file is in same directory)
set_background("cosmic-background-with-colorful-laser-lights-with-cool-shapes-perfect-digital-wallpaper.jpg")
